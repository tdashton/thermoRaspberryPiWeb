...
<head>
    ...
    <script type="text/javascript" src="<?php echo base_url('resources/js/jquery.canvasjs.min.js')?>"></script>
    <script type="text/javascript" src="<?php echo base_url('resources/js/jquery.datetimepicker.js')?>"></script>
